...
class ReportService:
    @staticmethod
    def get_revenue_report(db: Session, days: int = 30) -> List[RevenueReportItem]:
    ...
    @staticmethod
    def get_customer_report(db: Session) -> List[CustomerReportItem]:
    ...
    @staticmethod
    def get_inventory_report(db: Session) -> List[InventoryReportItem]:
    ...
    def get_dashboard_summary(db: Session) -> DashboardSummary:
        ...
        # Today's sales
        today_sales = db.query(func.sum(Sale.final_amount)).filter(
